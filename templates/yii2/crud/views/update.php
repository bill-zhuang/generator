...
$this->title = <?= $generator->generateString('修改' . \app\models\Util::getTableComment($generator->tableSchema->name) . ': ', ['modelClass' => Inflector::camel2words(StringHelper::basename($generator->modelClass))]) ?> . $model-><?= $generator->getNameAttribute() ?>;
